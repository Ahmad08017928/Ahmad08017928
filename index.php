...
if (isset($_POST['login'])) {
    ...
    $username = mysqli_real_escape_string($connet, $_POST['username']);
    $password = mysqli_real_escape_string($connet, $_POST['password']);

    // check username
    $result = mysqli_query($connet, "SELECT * FROM login WHERE username = '$username'");
    ...
    <div class="login-box">
        <div class="login-logo">
            <div class="text-center">
                <img class="mb-4" src="assets-template/img/FotoPPLG.png" alt="" width="67" height="67">
                <a href="#"><b>Invastory</b>PPLG</a>
            </div>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <p class="mb-1 text-center">
                    <span class="mt-5 mb-3 text-muted">Developer &copy;
                        <a href="https://www.instagram.com/ihm_adi_prnm?igsh=MTg3ZzFpdzY2ZmJkOA==">Ilham adi purnomo</a> <?= date('Y') ?>
                    </span>
                </p>
            </div>
            <!-- /.login-card-body -->
